...
describe('Documentation Frontmatter Validation', () => {
  ...
  const requiredFields = ['id', 'title', 'sidebar_label', 'sidebar_position', 'tags'];
      ...
      describe(`${fileName}`, () => {
        ...
        if (frontmatter) {
          ...
          it('should have valid sidebar_position field', () => {
            ...
            expect(typeof position === 'number' || typeof position === 'string').toBe(true);
          ...
          it('should have valid tags field', () => {
            ...
            const allowedTags = ['basics', 'mittelstufe', 'fortgeschritten', 'medien', 'prufung', 'B2', 'C1'];
  ...
  describe('All documentation files frontmatter validation', () => {
    ...
    it('should validate that all documentation files have required fields', () => {
      const filesWithMissingFields: Array<{file: string, missingFields: string[]}> = [];
